      ...
      <div className="relative w-full h-full overflow-y-auto overflow-x-hidden">
        <div className="min-h-full flex flex-col px-6 pt-14 pb-8">
          ...
          <div className="flex flex-col items-center mb-6">
            ...
            <h2 className="text-white text-lg font-light mb-0.5">SleepEase</h2>
            <p className="text-white/50 text-xs">General Mode</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex-1 flex flex-col">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-3.5 rounded-2xl bg-white/10 backdrop-blur-xl border border-white/20 text-white placeholder:text-white/30 focus:outline-none focus:border-blue-400/50 focus:bg-white/15 transition-all"
                    required
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-12 py-3.5 rounded-2xl bg-white/10 backdrop-blur-xl border border-white/20 text-white placeholder:text-white/30 focus:outline-none focus:border-blue-400/50 focus:bg-white/15 transition-all"
                    required
                  />
                  <button
                    type="button"
            ...
            <div className="text-center mt-auto">
              <p className="text-white/50 text-xs">
                ...
                <button
                  type="button"
                  onClick={() => navigate('general-signup')}
